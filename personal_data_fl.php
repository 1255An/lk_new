...
<div class="personal_data_page">
    <div class="form">
        ...
        <!--Форма личных данных для ФЛ-->

        <form action="#" method="post" id="form-pd-fl" name="form" class="form_body">
            <h1 class="form_title">Данные пользователя личного кабинета (ФЛ)</h1>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <!--Фамилия-->
                    <div class="col-half" style="width: 33%">
                        <div class="form_item">
...
<script>
    ...
    //   const formAgreementValue = document.querySelector('#formAgreement');
    const form = document.getElementById('form-pd-fl');
    ...
    function checkInputs() {
        ...
        if ($("#formAgreement").prop("checked") === false) {
            ...
            formAgreementValue.classList.add('_error');
            $("#formAgreement").css('border', '1px solid red');
            err++
        } else {
            setSuccessFor(formAgreementValue);
        }
        return err;
    }
